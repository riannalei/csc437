import{a as i,i as m,x as h,r as p,n as u}from"./state-CQOAiUN3.js";const g=i`
  * {
    margin: 0;
...
`,x={styles:f};var v=Object.defineProperty,n=(l,r,e,a)=>{for(var t=void 0,o=l.length-1,c;o>=0;o--)(c=l[o])&&(t=c(r,e,t)||t);return t&&v(r,e,t),t};const d=class d extends m{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password)}render(){return h`
      <form
    ...
    `];let s=d;n([p()],s.prototype,"formData");n([u()],s.prototype,"api");n([u()],s.prototype,"redirect");n([p()],s.prototype,"error");export{s as L};
